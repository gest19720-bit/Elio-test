const { ACCESS_TOKEN_TTL_SECONDS, REFRESH_TOKEN_TTL_SECONDS, oauthError, sendJson, sendOAuthError, secret, hash, nowPlus, requestBody, timingSafeEqual, supabase, resolveClient, validateRedirect, cors } = require('./_shared');
