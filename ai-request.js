...
const messageForCode = code => ({
  ...
  CUSTOMER_NOT_FOUND: 'This customer is no longer available. Refresh the page and try again.',
  CONTEXT_UNAVAILABLE: 'Elio could not load the customer context. Please try again.',
  ONBOARDING_REQUIRED: 'Complete your business setup before generating follow-ups.',
